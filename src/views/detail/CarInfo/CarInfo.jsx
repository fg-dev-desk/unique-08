    ...
    <div className="col-lg-4">
      <div className="car-single-info">
        ...
        <div className="car-single-rating">
          ...
          <span className="rating-count"> ({detailData.labels.customerReviews})</span>
        </div>
        ...
        <div className="car-single-auction-status mb-3">
          {isActive ? (
            <span className="badge bg-success mb-2">
              ...
              {detailData.labels.activeAuction}
            </span>
          ) : (
            <span className="badge bg-danger text-white">
              <i className="far fa-clock me-1"></i>
              {detailData.labels.auctionEnded}
            </span>
          )}
        </div>
        ...
        <div className="car-single-price">
          ...
          {isActive && (
            <a href="#pujar" className="theme-btn">{detailData.labels.bidNow}</a>
          )}
        </div>
        ...
        {carDetails.length > 0 && (
          <div className="car-single-details">
            <h5 className="mb-2">{detailData.labels.carDetails}</h5>
        ...
        {carTerms.length > 0 && (
          <div className="car-single-terms mb-3">
            <h5 className="mb-2">{detailData.labels.auctionTerms}</h5>
        ...
        {!isAuthenticated && isActive && (
          <div className="car-single-auth-message mb-4">
            <div className="alert alert-info">
              ...
              <strong>{detailData.labels.loginToParticipate}</strong>
              <br />
              <small>{detailData.labels.loginMessage}</small>
              <div className="mt-2">
        ...
        <div className="car-single-share">
          <h5 className="mb-3">{detailData.labels.shareAuction}</h5>
          <div className="car-single-share-icon">
            {detailData.socialSharing.platforms.map((platform, index) => (
